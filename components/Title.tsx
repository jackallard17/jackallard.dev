        ...
        <div className={classes.wrapper}>
          <Container size={700} className={classes.inner}>
            ...
            <Text className={classes.description} color="dimmed">
              Hello! My name is Jack and I am a Computer Science student with more than 2 years of professional software development experience.
            </Text>
            ...
            <Group className={classes.controls}>
              ...
              <Button
                component="a"
                href="https://github.com/jackallard17"
                size="xl"
                variant="outline"
